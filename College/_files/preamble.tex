...
\declaretheoremstyle[
  ...
  headformat=\parbox{\textwidth}{\centering\NAME~\arabic{solution}},
  notefont=\bfseries,
  headpunct=,
  mdframed={
    linewidth=0.5pt, linecolor=solution,
...
\declaretheoremstyle[
  headfont=\sffamily\color{main},
  headformat={\makebox[\textwidth][c]{\NAME~\NOTE}},
  headindent=0mm,
  bodyfont=\normalfont,
  notefont=\bfseries,
  notebraces={~ },
...
\declaretheorem[style=thmpurpleframeboxc, name=]{purpleframe}
\declaretheorem[style=thmpurpleframeboxl, name=]{purpleframel}
