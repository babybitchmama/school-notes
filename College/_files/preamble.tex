...
% Import Figures
\newcommand\incimg[3][1]{
  \def\svgwidth{#1\columnwidth}
  \includegraphics[width=#1\columnwidth]{\figloc-\@notenum/#2.png}
}
...
% Hat vectors
\newcommand\ah{\mathbf{\hat{a}}}
\newcommand\bh{\mathbf{\hat{b}}}
\newcommand\ch{\mathbf{\hat{c}}}
\renewcommand\dh{\mathbf{\hat{d}}}
\newcommand\eh{\mathbf{\hat{e}}}
\newcommand\ih{\mathbf{\hat{\imath}}}
\newcommand\jh{\mathbf{\hat{\jmath}}}
\newcommand\kh{\mathbf{\hat{k}}}
\newcommand\ph{\mathbf{\hat{p}}}
\newcommand\uh{\mathbf{\hat{u}}}
\newcommand\vh{\mathbf{\hat{v}}}
\newcommand\wh{\mathbf{\hat{w}}}
\newcommand\xh{\mathbf{\hat{x}}}
\newcommand\yh{\mathbf{\hat{y}}}
\newcommand\zh{\mathbf{\hat{z}}}
...
\newcommand\empheq[1]{\colorboxed{main}{\hspace{2em}#1\hspace{2em}}}
\makeatother
