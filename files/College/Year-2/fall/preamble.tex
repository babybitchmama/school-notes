...
% DESCRIPTION:                                                                 %
% ---------------------------------------------------------------------------- %
% I use this when I'm proving a proof using contradiction. So, at the end, I   %
% just use \contra, which replaces the regular QED symbol, which is a square   %
...
\@ifclasswith\class{nocolor}{
  ...
  \newtcbtheorem{Question}{Question}{enhanced,
    ...
    fonttitle=\bfseries,
    title=\textbf{Question: \arabic{question}},
  ...
  {\begin{Question}{#1}\stepcounter{question}{#2}}{\end{Question}}
  ...
  \newtcbtheorem{Solution}{Solution}{enhanced,
    ...
    attach boxed title to top left={yshift*=-\tcboxedtitleheight},
    fonttitle=\bfseries,
    title=\textbf{Solution: \arabic{solution}},
    boxed title size=title,
    boxed title style={%
      sharp corners,
      rounded corners=northwest,
  ...
  {\vspace{-10pt}\begin{Solution}\stepcounter{question}{#1}{#2}}{\end{Solution}}
}
\makeatother
