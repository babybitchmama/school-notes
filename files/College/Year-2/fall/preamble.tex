...
\@ifclasswith\class{nocolor}{
  ...
  \newcommand\qedsolution{{\color{qedsolution}\rule{3mm}{1.5mm}}}
  \declaretheoremstyle[
    headfont=\sffamily\zz\color{solution},
    bodyfont=\normalfont,
    notefont=\bfseries,
    headpunct=,
    postheadspace=\newline,
  ...
  \declaretheoremstyle[
    headfont=\sffamily\bfseries\zz\color{main},
...
\newtcolorbox[use counter=example]{purpleframe}{%
  colback=white,
  colframe=main,
  sharp corners,
  toprule=0.5pt,
