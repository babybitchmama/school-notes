...
\renewcommand\qed{{{\color{theorem}Q.E.D.}}}
...
\@ifclasswith\class{working}{
  \@ifclasswith\class{sidenotes}{
    ...
    % ------------------------------------------------------------------------ %
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \newenvironment{improvement}[1]{\begin{tcolorbox}[
        arc=0mm,
        colback=white,
        colframe=Plum!25,
        title=Improvement,
    ...
    \newenvironment{unsure}[1]{\begin{tcolorbox}[
        arc=0mm,
        colback=white,
        colframe=red!25,
        title=Unsure,
    ...
    \newenvironment{change}[1]{\begin{tcolorbox}[
        arc=0mm,
        colback=white,
        colframe=yellow!25,
        title=Change,
    ...
    \newenvironment{add}[1]{\begin{tcolorbox}[
        arc=0mm,
        colback=white,
        colframe=blue!25,
        title=Add,
    ...
    \newenvironment{info}[1]{\begin{tcolorbox}[
        arc=0mm,
        colback=white,
        colframe=OliveGreen!25,
        title=Info,
        fonttitle=\sffamily,
        breakable
    ]}{\end{tcolorbox}}
