...
\newcommand\lecture[2]{
  ...
  \setcounter{lecturecounter}{\lecnum}

  % Set the section number to the lecture counter.
  \setcounter{section}{\arabic{#1}}
  \renewcommand\thesubsection{\arabic{#1}.\arabic{subsection}}
...
\newcommand\createintro{
  ...
  \@ifclasswith\class{twocolumn}{\twocolumn}{\newpage}
...
\newcommand\incfig[2][1]{
  \ifnum \arabic{lecturecounter}=0
    \def\figlocation{./figures/}
  \else
    \ifnum \arabic{lecturecounter}<10
      \def\figlocation{./figures/lec-0\arabic{lecturecounter}}
    \else
      \def\figlocation{./figures/lec-\arabic{lecturecounter}}
    \fi
  \fi
