...
\begin{problem}[2]
  Show that smoothness of the inversion map is redundant in the definition of Lie group: if $G$ is a smooth manifold with a group structure such that the multiplication map is a smooth manifold with a group structure such that the multiplication map $m : G \times G \to G$, then $G$ is a Lie group.
