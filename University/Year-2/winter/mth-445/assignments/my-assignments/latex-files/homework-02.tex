\begin{problem}[23.4]
  Find all solutions of $x^3 - 2x^2 - 3x = 0$ in $\Z_6$.
\end{problem}

\begin{solution}
  The solutions are $x = 0, 2, 3$, and 5 in $\Z_6$.
\end{solution}
...
\begin{solution}[(i)]
  Breaking up $n = 1457$ into a product of primes, we get $n = 31 \times 47$. Therefore, $p = 31$ and $q = 47$. Next, we compute $\phi(n) = (p - 1)(q - 1) = 30 \times 46 = 1380$.
\end{solution}
