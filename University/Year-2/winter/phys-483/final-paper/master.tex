...
\begin{document}
  ...
  \begin{figure}[h]
    ...
    \begin{tikzpicture}[>=Stealth]
      ...
      \fill (-3.1, 1.1) circle (1.5pt) node[right, xshift=2] {\small $p$};
      ...
      \begin{scope}[shift={(1.5,0)}]
        ...
        \fill (-0.1, 1.1) circle (1.5pt) node[below] {\small $F(p)$};
      \end{scope}
      ...
      \begin{scope}[shift={(5.5,0)}]
        ...
        \fill (0.4, 1.1) circle (1.5pt) node[below] {\small $G(F(p))$};
      \end{scope}
      ...
      \draw[->, thick, red!70!black] (2.4, 1.8) to[bend left=20] node[midway, above] {\small $G$} (4.2, 1.8);
  ...
  \begin{figure}[h]
    ...
    \begin{tikzpicture}[>=Stealth, scale=1.3]
      ...
      % --- 5. MAPPING ARROWS ---
      \draw[->, thick, orange!80!black] (-1, 0.4) to[bend left=25] node[midway, above] {\huge $\widetilde{\varphi}$} (2, 0.4);
      \draw[->, thick, blue!70!black] (-2.8, -3.5) to[bend left=25] node[midway, above] {\huge $\varphi$} (2.8, -3.1);

      \draw[->, thick] (-3.5, -1.2) -- (-3.5, -2.8) node[midway, left] {\huge $\pi$};
      \draw[->, thick] (3.5, -1.2) -- (3.5, -2.8);
  ...
  Let $(M, g)$ be a manifold equipped with a Levi-Civita connection $\nabla$.
