...
\subsection{Sourcing the Waves: The Energy-Momentum Tensor} In the previous subsections, we established that perturbations of spacetime can propagate as waves through a vacuum. However, to understand the origin of these waves, we must look to the ``source'' side of the Einstein Field Equations: the energy-momentum tensor $T_{\mu\nu}$. This tensor describes the distribution and flow of mass, energy, and momentum throughout the manifold.
