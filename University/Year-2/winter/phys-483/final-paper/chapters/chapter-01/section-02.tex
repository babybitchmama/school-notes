...
\input{./chapters/chapter-01/figures/manifold-charts.tex}
\begin{definition}
...
\end{definition}
\input{./chapters/chapter-01/figures/smooth-functions.tex}
...
\end{definition}
\input{./chapters/chapter-01/figures/smooth-charts-between-m-and-n.tex}

A nice property (which we won't be proving), is that a composition of smooth maps is also smooth.

\input{./chapters/chapter-01/figures/composition-of-smooth-maps.tex}

\subsection{Metrics} Let $M$ be a manifold. We can define something called a metric that allows us to talk about distances and angles on the manifold. This is crucial for understanding the geometry of spacetime and the behavior of gravitational waves. We can define a metric as follows.
\begin{definition}
...
\input{./chapters/chapter-01/figures/tangent-space-of-s2.tex}
...
\input{./chapters/chapter-01/figures/coordinates-for-the-tangent-bundle.tex}
...
\input{./chapters/chapter-01/figures/fibres-and-sections.tex}
...
\input{./chapters/chapter-01/figures/the-differential.tex}
...
\input{./chapters/chapter-01/figures/pushforward-and-pullback.tex}

\subsection{Curvature} Next, we introduce the concept of curvature on a manifold, which is essential for understanding the curvature of spacetime and the behavior of gravitational waves. In order to describe curvature on a manifold, we must first introduce the notion of a connection, which allows us to differentiate vector fields in a manner compatible with the smooth structure of the manifold.
