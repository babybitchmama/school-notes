...
\begin{solution}[(ii)]
  ...
  \begin{align*}
    \Gamma_{tt}^r &= -\frac{1}{2}g^{rr}\pd{r}g_{tt} \\
    \Gamma_{rr}^r &= -\frac{1}{2}g^{rr}\pd{r}g_{rr} \\
    \Gamma_{\theta\theta}^r &= -\frac{1}{2}g^{rr}\pd{r}g_{\theta\theta} \\
    \Gamma_{\phi\phi}^r &= -\frac{1}{2}g^{rr}\pd{r}g_{\phi\phi} \\
    \Gamma_{r\theta}^\theta &= \frac{1}{2}g^{\theta\theta}\pd{r}g_{\theta\theta} = \Gamma_{\theta r}^\theta \\
    \Gamma_{\phi\phi}^\theta &= -\frac{1}{2}g^{\theta\theta}\pd{\theta}g_{\phi\phi} \\
    \Gamma_{r\phi}^\phi &= \frac{1}{2}g^{\phi\phi}\pd{r}g_{\phi\phi} = \Gamma_{\phi r}^\phi \\
    \Gamma_{\theta\phi}^\phi &= \frac{1}{2}g^{\phi\phi}\pd{\theta}g_{\phi\phi} = \Gamma_{\phi\theta}^\phi
  .\end{align*}
\end{solution}
...
\begin{solution}[(v)]
  ...
  .\]%
  For a bound orbit to exist, the effective potential must have a local minimum at some finite $r > 0$, so that the radial motion oscillates between two turning points. We check for extrema by differentiating $V_{\text{eff}}(r)$ with respect to $r$:
  \[%
    \odv{V_{\text{eff}}}{r} = -2\frac{L^2 + b}{r^3} - 4 \frac{bL^2}{r^5} = -\frac{2(L^2 + b) r^2 + 4 bL^2}{r^5}
  .\]%
  Setting $\odv{V_{\text{eff}}}/{r} = 0$ gives:
  \[%
