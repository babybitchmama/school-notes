...
\begin{solution}
  ...
  \[%
    ...
    \end{cases}
  \]%
  Take $U = (-0.1, 0.1)$. Then, we have
  \begin{align*}
    f^{-1}(U) &= \{(x, y) \in \R^2 \mid -0.1 < f(x, y) < 0.1\} \\
              &= \left\{(x, y) \in \R^2 \left\lvert -0.1 < \frac{xy}{x^2 + y^2} < 0.1\right\}\right\rvert \\
              &= \left\{(x, y) \in \R^2 \left\lvert -0.1(x^2 + y^2) < xy < 0.1(x^2 + y^2)\right\}\right\rvert \\
              &= \left\{(x, y) \in \R^2 \left\lvert 0.1x^2 - xy + 0.1y^2 > 0~\text{and}~0.1x^2 + xy + 0.1y^2 > 0\right\}\right\rvert \\
              &= \R^2 \setminus \left\{(x, y) \in \R^2 \left\lvert 0.1x^2 - xy + 0.1y^2 \leq 0~\text{or}~0.1x^2 + xy + 0.1y^2 \leq 0\right\}\right\rvert \\
              &= \R^2 \setminus \left\{(x, y) \in \R^2 \left\lvert (x - 5y)^2 \leq 0~\text{or}~(x + 5y)^2 \leq 0\right\}\right\rvert \\
              &= \R^2 \setminus \left(\{(5y, y) \mid y \in \R\} \cup \{(-5y, y) \mid y \in \R\}\right) \\
              &= \R^2 \setminus (L_1 \cup L_2)
  ,\end{align*}
  where $L_1$ and $L_2$ are the lines defined by $y = \frac{1}{5}x$ and $y = -\frac{1}{5}x$, respectively.
\end{solution}
