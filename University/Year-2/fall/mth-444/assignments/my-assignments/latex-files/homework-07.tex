...
\begin{solution}
  Suppose we have three groups, $(G, \oplus)$, $(G', \otimes)$, and $(G'', \circ)$. Let $\phi : G \to G'$ and $\gamma : G' \to G''$ be group homomorphisms. We want to show that the composition $\gamma \circ \phi : G \to G''$ is also a group homomorphism. Take any two elements $a, b \in G$. Then, we have
  \[%
    (\gamma \circ \phi)(a \oplus b) = \gamma(\phi(a \oplus b))
  .\]%
  Since $\phi$ is a group homomorphism, we know that
  \[%
    \gamma(\phi(a \oplus b)) = \gamma(\phi(a) \otimes \phi(b))
  .\]%
  Now, since $\gamma$ is also a group homomorphism, we have
  \[%
    \gamma(\phi(a) \otimes \phi(b)) = \gamma(\phi(a)) \circ \gamma(\phi(b))
  .\]%
  Therefore, we can conclude that
  \[%
    (\gamma \circ \phi)(a \oplus b) = (\gamma \circ \phi)(a) \circ (\gamma \circ \phi)(b)
  .\]%
  This shows that $\gamma \circ \phi$ preserves the group operation, and hence it is a group homomorphism.
\end{solution}
...
\begin{solution}
  Let $H$ be a subgroup of $S_n$ for $n \ge 2$. Take the $\sgn : S_n \to \{1, -1\}$ group homomorphism, and restrict it to $H$, giving us $\sgn|_H : H \to \{1, -1\}$. The kernel of this homomorphism is given by
  \[%
    \ker(\sgn|_H) = \{ \sigma \in H \mid \sgn(\sigma) = 1 \} = H \cap A_n
  .\]%
\end{solution}
...
\begin{solution}
  ...
  To find the order of the element $(3, 10, 9)$ in the direct product $\Z_4 \times \Z_{12} \times \Z_{15}$, we take the least common multiple (LCM) of the individual orders:
  \[%
    \ord(3, 10, 9) = \lcm(4, 6, 5) = 60
  .\]%
...
\begin{solution}
  ...
  \begin{gather*}
    G = \Z_8 \times \Z_{10} \times \Z_{24} \cong \Z_2 \times \Z_{2^3} \times \Z_{2^3} \times \Z_3 \times \Z_5 \\
    H = \Z_4 \times \Z_{12} \times \Z_{40} \cong \Z_{2^2} \times \Z_{2^2} \times \Z_{2^3} \times \Z_3 \times \Z_5
  .\end{gather*}
  The primary components of $G$ and $H$ are given as
  \begin{gather*}
    G_{(3)} \cong \Z_3 \cong H_{(3)}, \quad G_{(5)} \cong \Z_5 \cong H_{(5)} \\
    G_{(2)} \cong \Z_2 \times \Z_{2^3} \times \Z_{2^3} \not\cong \Z_{2^2} \times \Z_{2^2} \times \Z_{2^3} \cong H_{(2)}
  .\end{gather*}
...
\begin{solution}
  ...
  \[%
    \Z_8 \times \Z_3, \quad \Z_4 \times \Z_2 \times \Z_3, \quad \Z_2 \times \Z_2 \times \Z_2 \times \Z_3
  .\]%
  ...
  \begin{gather*}
    \Z_8 \times \Z_3 \times \Z_{25}, \quad \Z_8 \times \Z_3 \times \Z_5 \times \Z_5, \\
    \Z_4 \times \Z_2 \times \Z_3 \times \Z_{25}, \quad \Z_4 \times \Z_2 \times \Z_3 \times \Z_5 \times \Z_5, \\
