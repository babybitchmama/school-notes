...
\begin{problem}[1.10.3]
  In each case, find all the roots in rectangular coordinates, exhibit them as vertices of certain regular polygons, and identify the principle root
  \[%
...
\begin{solution}[(i)]
  ...
  \[%
    u_x = 1, \quad u_y = 0, \quad v_x = 0, \aand v_y = -1
  .\]%
...
\begin{solution}[(ii)]
  ...
  We compute the partial derivatives
  \[%
    u_x = 0, \quad u_y = 0, \quad v_x = 0, \aand v_y = 2
  .\]%
  Now, we check the Cauchy-Riemann equations
  \[%
    u_x \ne v_y \aand u_x = v_y
...
\begin{solution}[(iii)]
  ...
  We compute the partial derivatives
  \[%
    u_x = 2, \quad u_y = 0, \quad v_x = y^2, \aand v_y = 2xy
  .\]%
...
\begin{solution}[(iv)]
  ...
  We compute the partial derivatives
  \[%
    u_x = e^x\cos(y), \quad u_y = -e^x\sin(y), \quad v_x = -e^x\sin(y), \aand v_y = -e^x\cos(y)
  .\]%
...
\begin{solution}[(ii)]
  ...
  \begin{alignat*}{3}
    ...
    v_x &= 0,\quad &&v_y &= 2y
  \end{alignat*}
  The Cauchy-Riemann equations hold only when $x = y$. Evaluating the derivative
  at $f(x + ix)$, we have
  \[%
    f'(x + ix) = \odv{}{z}(x^2 + ix^2) = 2x + 2ix = 2x(1 + i)
  .\qedhere\]%
\end{solution}
