...
\begin{solution}[(i)]
  The poles of the integrand are at $z = 1$ and $z = \pm 3i$. The circle $\abs{z - 2} = 2$ contains the pole at $z = 1$ but not the poles at $z = 3i$ and $z = -3i$. We can use the residue theorem to evaluate the integral.
  ...
  \[%
    \Res_{z=1} f(z) = \lim_{z \to 1} (z - 1) f(z) = \lim_{z \to 1} (z - 1) \frac{3z^3 + 2}{(z - 1)(z^2 + 9)} = \lim_{z \to 1} \frac{3z^3 + 2}{z^2 + 9}
  .\]%
  Evaluating this limit, we get
  \[%
    \Res_{z=1} f(z) = \frac{3(1)^3 + 2}{(1)^2 + 9} = \frac{3 + 2}{1 + 9} = \frac{5}{10} = \frac{1}{2}
  .\]%
...
\begin{solution}[(ii)]
  ...
  For the pole at $z = 1$, we already calculated the residue:
  \[%
    \Res_{z=1} f(z) = \frac{1}{2}
  .\]%
  Now, we calculate the residues at the poles $z = 3i$ and $z = -3i$.

  For the pole $z = 3i$, we can use the function
  \[%
    f(z) = \frac{\Phi(z)}{z - 3i} \qtq{where} \Phi(z) = \frac{3z^3 + 2}{(z - 1)(z + 3i)}
  .\]%
  The residue at $z = 3i$ is given by
  \[%
    \Res_{z=3i} f(z) = \Phi(3i) = \frac{3(3i)^3 + 2}{(3i - 1)(3i + 3i)} = \frac{3(-27i) + 2}{(3i - 1)(6i)} = \frac{-81i + 2}{(3i - 1)(6i)} = \frac{5(3 - i)}{12}
  .\]%
  ...
  The residue at $z = -3i$ is given by
  \[%
    \Res_{z=-3i} f(z) = \Phi(-3i) = \frac{3(-3i)^3 + 2}{(-3i - 1)(-3i - 3i)} = \frac{3(27i) + 2}{(-3i - 1)(-6i)} = \frac{5(3 + i)}{12}
  .\]%

  Now, we can sum the residues
  \[%
    \Res_{z=1} f(z) + \Res_{z=3i} f(z) + \Res_{z=-3i} f(z) = \frac{1}{2} + \frac{5(3 - i)}{12} + \frac{5(3 + i)}{12} = 3
  .\]%
  By the residue theorem, the value of the integral is given by
  \[%
