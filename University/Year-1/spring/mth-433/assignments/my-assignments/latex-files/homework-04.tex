...
\begin{solution}
  ...
  \[%
    \mathbf{x}(u,v) = \left(\left(1 + \frac{v}{2} \cos\left(\frac{u}{2}\right)\right) \cos(u), \left(1 + \frac{v}{2} \cos\left(\frac{u}{2}\right)\right) \sin(u), \frac{v}{2} \sin\left(\frac{u}{2}\right)\right)
  ,\]%
