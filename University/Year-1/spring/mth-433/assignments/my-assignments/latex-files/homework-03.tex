...
\begin{problem}[2.4.8]
  Prove that if $L : \R^3 \to \R^3$ is a linear map and $S \subset \R^3$ is a regular surface invariant under $L$, i.e., $L(S) \subset S$, then the restriction $L\mid_S$ is a differential map and
  \[%
...
\begin{solution}
  ...
  % \[%
  %   \dd{\Phi_p}(\w) = \odv{}{t} \bigg\mid_{t=0} (\Phi \circ \beta)(t)
  % .\]%
\end{solution}
