...
\begin{proof}[Solution to (i)]
  Suppose $(f_n)$ and $(g_n)$ converge uniformly to a limit $f$ and $g$ on $A$
  respectively. This means that $\lvert f_n(x) - f(x) \rvert <
  \sfrac{\epsilon}{2}$ and $\lvert g_n(x) - g(x) \rvert < \sfrac{\epsilon}{2}$,
  for all $n \ge N_1$ and $N_2$ respectively. Then $\lvert f_n(x) - f(x) \rvert
  + \lvert g_n(x) - g(x) \rvert < \sfrac{\epsilon}{2} + \sfrac{\epsilon}{2} =
  \epsilon$.
\end{proof}
