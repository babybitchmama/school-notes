...
\begin{proof}[Solution to (i)]
  ...
  \[%
    L(1) = \int_1^1 \frac{1}{t} \,\dt = \ln(\lvert t \rvert)\bigg\vert_1^1 = \ln(1) - \ln(1) = 0
  .\]%
  Since the integrand $\sfrac{1}{t}$ is continuous on $(0, \infty)$, $L$ is
  differentiable on $(0, \infty)$. By the Fundamental Theorem of Calculus, part
  (ii), we have
  \[%
...
\begin{proof}[Solution to (ii)]
  ...
  .\]%
  This means $g'(x) = L'(x) \implies g(x) = L(x) + C$. To find $C$, let $x = 1$
  and evaluate, giving us
  \[%
...
\begin{proof}[Solution to (iii)]
  ...
  .\]%
  This means $g'(x) = L'(x) \implies g(x) = L(x) + C$. To find $C$, let $x = y$
  and evaluate, giving us
  \[%
