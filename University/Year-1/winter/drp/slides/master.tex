...
\begin{document}
  ...
  \begin{frame}{Representations}
    ...
    $\pi$ of a Lie algebra $\ggl$ on a vector space $V$, I'll write $(\pi, G,
    V)$.
  \end{frame}
  ...
  \begin{frame}{Irreducible and Isomorphic representations}
    ...
    representation $(\pi, V)$ of a Lie algebra $\ggl$ is irreducible if it has
    no nontrivial invariant subspaces under the action of $\pi(X)$ for all $X
    \in \ggl$.
  \end{frame}
