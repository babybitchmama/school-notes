\begin{problem}[1]
  ...
  \begin{enumerate}
    ...
    \item $\displaystyle \iint_D 2xy^3 \,\dA$ where $D$ is the region bounded by
      $y = x$, $y = \frac{1}{x}$, and $y = 2$.
  \end{enumerate}
\end{problem}
...
\begin{proof}[Solution]
  ...
  the positive root. Therefore, we get the bounds $0 \le y \le 4$ and $0 \le x
  \le \sqrt{y}$. Expanding the double integral into an iterated integral gives
  us
  \begin{align*}
