\begin{problem}[1]
  Evaluate $\displaystyle\int_C \FF \cdot \dd{\r}$ for the vector field $\FF =
  (x + z)\ui + 2y\uj + (y + 2x)\uk$ where $C$ is
  \begin{enumerate}
...
\begin{problem}[3]
  Evaluate $\displaystyle\int_C \FF \cdot \dd{\r}$. Use the fundamental theorem for line integrals whenever it applies.
  \begin{enumerate}
...
\begin{proof}[Solution to (i)]
  ...
  segment $C$ is
  \begin{align*}
    \int_C \FF \cdot \dd{\r} = \int_C \nabla f \cdot \dd{\r} &= f(0, 3) - f(-1, 0) \\
...
\begin{proof}[Solution to (iii)]
  ...
  helix $C$ is
  \begin{align*}
    \int_C \FF \cdot \dd{\r} = \int_C \nabla f \cdot \dd{\r} &= f(\pi, -2, 0) - f(0, 2, 0) \\
...
\begin{proof}[Solution to (iv)]
  ...
  \begin{align*}
    \oint_C \FF \cdot \dd{\r} &= \int_0^{\frac{\pi}{2}} \FF(t) \cdot \r'(t) \,\dt \\
