...
\begin{proof}[Solution to (i)]
  ...
  \end{align}
  Integrating equation \ref{eq:3_i_1} with respect to $x$, we have
  \begin{align*}
    f = \int f_x \,\dx &= \int 2xe^{xy} + x^2ye^{xy} + 3x^2 \,\dx \\
                       &= \textrm{TODO} \\
                       &= x^2e^{xy} + x^3 + g(y)
  .\end{align*}
  Plugging this into equation \ref{eq:3_i_2}, we have
  \[%
    f_y = x^3e^{xy} + h'(y) = Q \implies h'(y) = 2\sin(y) \implies h(y) = -2\cos(y)
  .\]%
  Therefore, the potential function is
  \[%
    f(x, y) = x^2e^{xy} + x^3 - 2\cos(y)
  .\]%
  Therefore, the line integral over the vector field $\FF$ along the line segment $C$ is
  \begin{align*}
...
\begin{proof}[Solution to (ii)]
  ...
  Therefore, the potential function is
  \[%
    f(x, y) = y^3x - x^2 - \frac{1}{\pi}\cos(\pi y)
  .\]%
...
\begin{proof}[Solution to (iv)]
  ...
  Since $C$ is the intersection of the sphere $x^2 + y^2 + z^2 = 4$ and the
  plane $x = 1$ in the first octant, we get $x = 1$, $y^2 + z^2 = 3$, and $y,
  z \ge 0$. Therefore, we have
  \[%
    \r(t) = \langle 1, \sqrt{3}\cos(t), \sqrt{3}\sin(t) \rangle \implies \r'(t) = \langle 0, -\sqrt{3}\sin(t), \sqrt{3}\cos(t) \rangle
  .\]%
  The bounds for $t$ are $0 \le t \le \frac{\pi}{2}$. Converting $\FF$ from a
  vector function of $x$ and $y$ to a vector function of $t$, we have
  \[%
    \FF(x, y) = \langle y + z, x - 2z, x + 2y \rangle = \langle \sqrt{3}\cos(t) + \sqrt{3}\sin(t), 1 - 2\sqrt{3}\sin(t), 1 + 2\sqrt{3}\cos(t) \rangle = \FF(t)
  .\]%
  Evaluating the dot product of $\FF$ and $\r'$, we have
  \begin{align*}
    \FF(t) \cdot \r'(t) &= \left\langle \sqrt{3}\cos(t) + \sqrt{3}\sin(t), 1 - 2\sqrt{3}\sin(t), 1 + 2\sqrt{3}\cos(t) \right\rangle \cdot \left\langle 0, -\sqrt{3}\sin(t), \sqrt{3}\cos(t) \right\rangle \\
                        &= (\sqrt{3}\cos(t) + \sqrt{3}\sin(t))(0) + (1 - 2\sqrt{3}\sin(t))(-\sqrt{3}\sin(t)) + (1 + 2\sqrt{3}\cos(t))(\sqrt{3}\cos(t)) \\
                        &= -\sqrt{3}\sin(t) + 6\sin^2(t) + \sqrt{3}\cos(t) + 6\cos^2(t) \\
                        &= \sqrt{3}\cos(t) -\sqrt{3}\sin(t) + 6
  .\end{align*}
  Therefore, the line integral over the vector field $\FF$ along the curve $C$ is
  \begin{align*}
    \int_C \FF \cdot \dd{\r} &= \int_0^{\frac{\pi}{2}} \FF(t) \cdot \r'(t) \,\dt \\
                             &= \int_0^{\frac{\pi}{2}} \sqrt{3}\cos(t) -\sqrt{3}\sin(t) + 6 \,\dt \\
                             &= \left[\sqrt{3}\sin(t) + \sqrt{3}\cos(t) + 6t\right] \bigg\vert_0^{\frac{\pi}{2}} \\
                             &= \left[\sqrt{3} + 3\pi\right] - \left[\sqrt{3}\right] = 3\pi
  .\qedhere\end{align*}
\end{proof}
