...
\begin{problem}[2]
  For any continuous $f(x, y, z)$, write $\iiint_E f(x, y, z) \,\dd{V}$ as an
  iterated integral in the six orders of integration where $E$ is a solid
  bounded by the surfaces $z = 0$, $x = 0$, $y + 2z = 2$, and $y = \sqrt{x}$.
  Clearly sketch the solid and each of the projections of E onto the coordinate
  planes.
\end{problem}
