...
\begin{proof}[Solution to (i)]
  ...
  \begin{align*}
    ...
    \begin{pmatrix}
      ...
      b \\
    \end{pmatrix} \\
             &= \overline{a}a \langle \x, \x \rangle + \overline{a}b \langle \x, \y \rangle + \overline{b}a \langle \y, \x \rangle + \overline{b}b \langle \y, \y \rangle \\
...
\begin{proof}[Solution]
  Using the Gram-Schmidt process, we can find the orthonormal basis for the
  column space of $A$. We start with the first column, given $\v_1$, $\v_2$, and
  $\v_3$ as
  \[%
    \v_1 = \begin{pmatrix}
      0 \\
  ...
  Let $\u_1 = \v_1$. We then have to normalize $\u_1$ to get
  \[%
    \hat{\u}_1 = \frac{\v_1}{\lVert \v_1 \rVert} = \frac{1}{\sqrt{2}}
    \begin{pmatrix}
      0 \\
      -1 \\
      1 \\
  ...
  Next, we compute $\u_2$ as
  \[%
    \u_2 = \v_2 - \langle \hat{\u}_1, \v_2 \rangle \hat{\u}_1 =
    \begin{pmatrix}
      0 \\
      0 \\
      2 \\
    ...
    \end{pmatrix}
  .\]%
  We then normalize $\u_2$ to get
  \[%
    \hat{\u}_2 = \frac{\u_2}{\lVert \u_2 \rVert} =
    \frac{1}{\sqrt{2}}
    \begin{pmatrix}
      0 \\
      1 \\
  ...
  Finally, we compute $\u_3$ as
  \begin{align*}
    \u_3 = \v_3 - \langle \hat{\u}_1, \v_3 \rangle \hat{\u}_1 - \langle \hat{\u}_2, \v_3 \rangle \hat{\u}_2 &=
    \begin{pmatrix}
      1 \\
      0 \\
      2 \\
    ...
    \end{pmatrix}
  .\end{align*}
  We then normalize $\u_3$ to get
  \[%
    \hat{\u}_3 = \frac{\u_3}{\lVert \u_3 \rVert} =
    \begin{pmatrix}
      1 \\
      0 \\
      0 \\
  ...
  We now have the orthonormal basis $\{\hat{\u}_1, \hat{\u}_2, \hat{\u}_3\}$.
  Therefore, the matrix $Q$ and $Q^T$ is
  \[%
    Q = \begin{pmatrix}
      0 & 0 & 1 \\
  ...
  \begin{align*}
    ...
    \end{pmatrix} \\
    &= \begin{pmatrix}
      \left(-\sfrac{\sqrt{2}}{2}\right) \cdot (-1) + \left(\sfrac{\sqrt{2}}{2}\right) \cdot (1) & \left(\sfrac{\sqrt{2}}{2}\right) \cdot (2) & \left(\sfrac{\sqrt{2}}{2}\right) \cdot (2) \\
      \left(\sfrac{\sqrt{2}}{2}\right) \cdot (-1) + \left(\sfrac{\sqrt{2}}{2}\right) \cdot (1) & \left(\sfrac{\sqrt{2}}{2}\right) \cdot (2) & \left(\sfrac{\sqrt{2}}{2}\right) \cdot (2) \\
      0 & 0 & 1 \\
    \end{pmatrix}
    =
...
\begin{problem}[6]
  ...
  eigenvalue/eigenvector pair of A. Prove that $(\overline{\lambda}, \v)$ is an
...
\begin{proof}[Solution]
  ...
  that $A^*\v = \overline{\lambda}\v$. Therefore, $(\overline{\lambda}, \v)$ is
  an eigenpair of $A^*$.
\end{proof}
...
\begin{proof}[Solution]
  ...
  = \overline{\lambda_2}\v_2$. Thus, $\langle \v_1, A^*\v_2 \rangle = \langle
  \v_1, \overline{\lambda_2}\v_2 \rangle = \lambda_2 \langle \v_1, \v_2
  \rangle$.
  ...
  \overline{\lambda_2} \langle \v_1, \v_2 \rangle$. Rearranging, we get
  $(\lambda_1 - \overline{\lambda_2}) \langle \v_1, \v_2 \rangle = \zero$. Since
  $\lambda_1$ and $\lambda_2$ are distinct, we have $\lambda_1 -
  \overline{\lambda_2} \ne \zero$.
