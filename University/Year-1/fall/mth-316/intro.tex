{\small
  ...
  We will introduce the concept of infinite series and the notion of convergence. The course will cover several convergence tests, including (but not limited to) the Comparison Test, Ratio Test, Root Test, and Limit Test, with proofs of each. We will also study conditional and absolute convergence, and conclude with the Riemann Series Theorem.
