...
\begin{worksheet}
  Given $(a_n)$, we need to show that if $\lim_{n \to \infty} a_n = a$, then $(a_n)$ is bounded. Using the definition of a limit, $(\forall \epsilon > 0)(\exists N \in \N)(\forall n > N)[|a_n - a| < \epsilon]$. Expanding the triangle inequality, we get
  \[%
