\nte{Oct 2 2024 Wed (13:02:51)}{Triangle Inequality}
...
\begin{definition}[Function]
  ...
  Let $A$ and $B$ be two sets. A \textbf{function} $f : A \to B$ assigns an
  element from the \textbf{domain} $A$ to the \textbf{range} $B$.
\end{definition}

\begin{example}
  \label{exm:function_1}
...
\end{example} $ $\vspace{-0.8cm}

\begin{example}
  \label{exm:function_2}
...
\begin{equation}\label{eq:abs_val}
  \empheq{
...
The second property is known as the \textbf{Triangle Inequality}, and it's
mostly used with three numbers, $a$, $b$, and $c$. Rearranging the inequality,
we get
\[%
