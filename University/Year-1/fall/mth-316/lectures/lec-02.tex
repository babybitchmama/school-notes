\nte[Section 1.2]{Oct 2 2024 Wed (13:02:51)}{Triangle Inequality}

\section{Functions}
\label{sec:functions}

\begin{definition}[Function]
  Let $A$ and $B$ be two sets. A \textit{function} $f : A \to B$ assigns an
  element from the \textit{domain} $A$ to the \textit{range} $B$.
\end{definition}
...
The second property is known as the \textit{Triangle Inequality}, and it's
