\lecture{9}{Oct 21 2024 Mon (13:02:06)}{Monotone Convergence Theorem}

\section{Monotone Convergence Theorem}

\begin{definition}[Monotone]
  A sequence $(a_n)$ is \emph{increasing} if $(\forall n \in \N)[a_n \le
  a_{n+1}]$ and \emph{decreasing} if $(\forall n \in \N)[a_n \ge a_{n+1}]$. A
  sequence is \emph{monotone} if it is either increasing or decreasing.
\end{definition}
