\nte[Sections 1.2 and 1.3][]{Oct 4 2024 Fri (13:00:10)}{Axiom of Completeness}
...
\begin{proof}
  ...
  \in \Z)[\sfrac{p}{q} \in \Z]$. Assume that $\sfrac{p}{q}$ is in simplest form,
  ...
  integer. Then $(\exists r)[r \in \N]$ such that $p = 2r$, giving us $4r^2 =
  2q^2$. This means $q^2$ is also an even integer, which is a contradiction,
  since $p$ and $q$ were assumed to be in simplest form. Therefore, $\sqrt{2}$
  is irrational.
\end{proof}
...
\begin{example}
  ...
  \N\right\}$, giving us $\sup(A) = \max(A) = 2$, but $\inf(A) = 1 \ne \min(A)$,
