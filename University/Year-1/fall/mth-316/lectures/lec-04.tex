...
\begin{proof}
  ...
  property, $(\exists n \in \N)[\sfrac{1}{n} < b - a \iff a < b -
  \sfrac{1}{n}]$.
...
\begin{proof}
  ...
  density of $\Q$, then there exists $r \in \Q$ such that $a - \sqrt{2} < r_1 <
  b - \sqrt{2} \implies a < r + \sqrt{2} < b$. Since $r$ is rational, then $r +
