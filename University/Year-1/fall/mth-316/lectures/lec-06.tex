...
\begin{worksheet}
  ...
  \begin{note}
    We aren't using a fixed $\epsilon$, since, say $\epsilon = \frac{1}{10}$,
    then $N > 100$, say $N = 101$, and were done, so that's just trivial
  \end{note}
...
\begin{proof}
  Let $\epsilon > 0$ be arbitrarily chosen. Chose a natural number $N$
  satisfying
  \[%
    N > \frac{1}{\epsilon^2}
  .\]%
