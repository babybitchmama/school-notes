...
\begin{proof}[Solution to (i)]
  Every divisor of $13$ is either $13$ or $1$, meaning $13$ is prime, which is
  true.
\end{proof}

\begin{proof}[Solution to (ii)]
  There exists a natural number between $51$ and $52$, which is false.
\end{proof}

\begin{proof}[Solution to (iii)]
  Every natural number whose square is $2$ is $5$, which is false.
\end{proof}

\begin{proof}[Solution to (iv)]
  For every natural number, there exists a natural number which divides it,
  which is true.
\end{proof}

\begin{proof}[Solution to (v)]
  For every natural number that's a divisor of both $4$ and $6$, it is also a
  divisor of $24$, which is true.
\end{proof}
...
\begin{proof}[Solution to (i)]
  $(\forall a)([a \in \Z \land a \equiv_2 0] \implies 5 \mid a)$.
\end{proof}

\begin{proof}[Solution to (ii)]
  $(\forall x)(x \in \Z \implies 5 < x)$.
\end{proof}

\begin{proof}[Solution to (iii)]
  $(\forall x)([x \in Z \land \sqrt{x} \in \Z] \implies \sqrt[3]{x} \in \Z)$.
\end{proof}

\begin{proof}[Solution to (iv)]
  $(\forall x)([x \in \Z \land x \neq 0] \implies [6 \mid x \lor 7 \mid x])$.
\end{proof}

\begin{proof}[Solution to (v)]
  $(\exists x)(\forall y)([x \in \Z \land y \in \Z] \implies x > y)$.
\end{proof}

\begin{proof}[Solution to (vi)]
  $(\exists a)(\forall b)([a \in A \land b \in A] \implies a \mid b)$.
\end{proof}

\begin{proof}[Solution to (vii)]
  $(\forall a)(a \in A \implies [a \equiv_2 0 \lor 13 \mid a])$.
\end{proof}

\begin{proof}[Solution to (viii)]
  $(\exists x)(x \in \Z \implies (\forall y)[y \in \Z \land y \mid 240 \implies
  x \nmid y])$.
\end{proof}

\begin{proof}[Solution to (ix)]
  $(\forall x)(x \in \Z_5 \land x \neq 0 \implies (\exists x^{-1})[x^{-1} \in
  \Z_5 \land xy = 1])$.
\end{proof}

\begin{proof}[Solution to (x)]
  $(\forall x)([x \in \Z \land x \equiv_8 3] \implies (\exists y)[y \in \Z \land xy \equiv_8 1])$.
\end{proof}

\begin{proof}[Solution to (xi)]
  $(\exists x)(x \in \Z \implies [(x \equiv_2 0 \land (\forall a)(\forall b)([a
  \in \Z \land b \in \Z \land x \mid ab] \implies [x \mid a \lor x \mid b]))])$.
\end{proof}
...
\begin{proof}[Solution to (iii)]
  $\{2, 5, 8, 10, 13, 17, 18, 20\}$. If we're including $0 \in \N$, then we get
  the set $\{0, 1, 2, 4, 5$, $8, 9, 10, 13, 16, 17, 18, 20\}$.
\end{proof}
...
\begin{proof}[Solution to (i)]
  $(\exists y)[y \in \Z \land y \leq 0]$. The negation is \textit{true}.
\end{proof}

\begin{proof}[Solution to (ii)]
  $(\exists x)[(x \in \Z \land 2 \mid x) \land 4 \nmid x ]$. The negation is
  \textit{true}.
\end{proof}

\begin{proof}[Solution to (iii)]
  $(\exists x)[x \in \Z_6 \land (\forall y)[y \in \Z_6 \implies x +_6 \ne 0]]$.
  The negation is \textit{false}.
\end{proof}

\begin{proof}[Solution to (vi)]
  $(\forall x)[x \in \Z_6 \implies (\exists y)[y \in \Z_6 \land x +_6 y \ne
  0]]$. The negation is \textit{true}.
\end{proof}

\begin{proof}[Solution to (v)]
  $(\exists x)[x \in \Z \land (\forall y)[y \in \Z \implies x \ne y^2]]$. The
  negation is \textit{true}.
\end{proof}

\begin{proof}[Solution to (vi)]
  $(\forall a)[a \in \N \implies (\exists b)[(b \in \N \land a \ne b) \land b
  \le a]]$. The negation is \textit{true}.
\end{proof}

\begin{proof}[Solution to (vii)]
  $(\forall m)(\forall n)[m \in \Z \land n \in \N \implies m \le n]$. The
  negation is \textit{false}.
\end{proof}

\begin{proof}[Solution to (viii)]
  $(\exists m)(\exists n)[m \in \N \land n \in \N \land m \le n]$. The negation
  is \textit{true}.
\end{proof}

\begin{proof}[Solution to (ix)]
  $(\forall m)[m \in \N \implies (\exists n)[n \in \N \land m \le n]]$. The
  negation is \textit{true}.
\end{proof}

\begin{proof}[Solution to (x)]
  $(\exists m)[m \in \N \land (\forall n)[n \in \N \implies m \le n]]$. The
  negation is \textit{true}.
\end{proof}

\begin{proof}[Solution to (xi)]
  $(\exists a)(\exists b)[(a \in \R \land b \in \R \land a < b) \land (\forall
  c)[c \in \R \implies [a \ge c \lor c \ge b]]]$. The negation is
  \textit{false}.
\end{proof}
...
\begin{proof}[Solution]
  ...
  \begin{enumerate}
    ...
    \item No, we could not have used $k$ or $y$ in step 5. We needed a new
      variable to represent the integer that divides $b^k$. \qedhere
  \end{enumerate}
\end{proof}
...
\begin{proof}[Solution]
  ...
  \begin{enumerate}
    ...
    \item The logic rules used in lines 25 and 26 are Inference by Cases
      (IC) and Modus Ponens (MP). \qedhere
  \end{enumerate}
\end{proof}
