...
\begin{proof}[Solution to (i)]
  True. Example: $4^2 \equiv_9 7$ and $5^2 \equiv_9 7$.
\end{proof}

\begin{proof}[Solution to (ii)]
  False. Counterexample: $7^2 \equiv_{11} 49 \equiv_{11} 16$ since $7 \not\equiv_{11} 4$.
\end{proof}

\begin{proof}[Solution to (iii)]
  True. Example: $n = 1$ and $n = 2$.
\end{proof}

\begin{proof}[Solution to (iv)]
  False. Counterexample: $n = 4$.
\end{proof}

\begin{proof}[Solution to (v)]
  True. Example: $a = 1$ and $b = -1$.
\end{proof}
...
\begin{proof}[Solution to (vii)]
  True. For $n \equiv_2 1$ and $n > 3$, $n$ is an odd integer greater than $3$.
  For any odd $n$, $n^2 - 1$ can be factored as $(n - 1)(n + 1)$. Since $n$ is
  odd, both $n - 1$ and $n + 1$ are even. So one of them is divisible by $3$.
  Thus $3 \mid n^2 - 1$, for all add $n > 3$.
\end{proof}

\begin{proof}[Solution to (viii)]
  False. Counterexample: $a = 6$ and $b = 4$.
\end{proof}
