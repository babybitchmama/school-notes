...
% Vectors
\newcommand\vectype{bold}
\newcommand\vectortype[1]{
  \ifthenelse{\equal{\vectype}{bold}}{%
    \mathbf{#1}
  }{%
    \vec{#1}
  }
...
\renewcommand\a{\vectortype{a}}
\renewcommand\b{\vectortype{b}}
\renewcommand\c{\vectortype{c}}
\renewcommand\d{\vectortype{d}}
\newcommand\e{\vectortype{e}}
\newcommand\f{\vectortype{f}}
\newcommand\g{\vectortype{g}}
\newcommand\n{\vectortype{n}}
\newcommand\p{\vectortype{p}}

\renewcommand\r{\vectortype{r}}
\newcommand\rr{\vectortype{r}^{\prime}}
\newcommand\rrr{\vectortype{r}^{\prime\prime}}

\newcommand\Ta{\vectortype{T}}
\newcommand\Taa{\vectortype{T}^{}}

\renewcommand\u{\vectortype{u}}
\newcommand\uu{\vectortype{u}^{\prime}}
\newcommand\uuu{\vectortype{u}^{\prime\prime}}

\renewcommand\v{\vectortype{v}}
\newcommand\vv{\vectortype{v}^{\prime}}
\newcommand\vvv{\vectortype{v}^{\prime\prime}}

\newcommand\w{\vectortype{w}}
\newcommand\x{\vectortype{x}}
\newcommand\y{\vectortype{y}}
\newcommand\z{\vectortype{z}}

\newcommand\zero{\vectortype{0}}

% Hat vectors
\newcommand\ah{\hattype{a}}
\newcommand\bh{\hattype{b}}
\newcommand\ch{\hattype{c}}
\renewcommand\dh{\hattype{d}}
\newcommand\eh{\hattype{e}}
\newcommand\ph{\hattype{p}}
\newcommand\uh{\hattype{u}}
\newcommand\vh{\hattype{v}}
\newcommand\wh{\hattype{w}}
\newcommand\xh{\hattype{x}}
\newcommand\yh{\hattype{y}}
\newcommand\zh{\hattype{z}}

% Unit vectors
\newcommand\ui{\ifthenelse{\equal{\vectype}{bold}}{\mathbf{i}}{\hat{\imath}}}
\newcommand\uj{\ifthenelse{\equal{\vectype}{bold}}{\mathbf{j}}{\hat{\jmath}}}
\newcommand\uk{\ifthenelse{\equal{\vectype}{bold}}{\mathbf{k}}{\hat{k}}}
