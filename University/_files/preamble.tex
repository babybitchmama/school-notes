...
% Main macro
\ExplSyntaxOn
\NewDocumentCommand\getDiff{O{} m}{
  % \IfSubStr{#2}{p}{\pd}{\dd}
  \IfSubStr{#2}{v}{\dd{\mathbf{#1}}}{\dd{\mathbf{#1}}}
}
\ExplSyntaxOff

\newcommand\dA[1][]{\getDiff{#1}{A}}
\newcommand\dV[1][]{\getDiff{#1}{V}}
\newcommand\dm[1][]{\getDiff{#1}{m}}
\newcommand\ds[1][]{\getDiff{#1}{s}}
\newcommand\dS[1][]{\getDiff{#1}{S}}
\newcommand\dw[1][]{\getDiff{#1}{w}}
\newcommand\dt[1][]{\getDiff{#1}{t}}
\newcommand\dr[1][]{\getDiff{#1}{r}}
\newcommand\dT[1][]{\getDiff{#1}{T}}
\newcommand\du[1][]{\getDiff{#1}{u}}
\newcommand\dv[1][]{\getDiff{#1}{v}}
\newcommand\dx[1][]{\getDiff{#1}{x}}
\newcommand\dy[1][]{\getDiff{#1}{y}}
\newcommand\dz[1][]{\getDiff{#1}{z}}
