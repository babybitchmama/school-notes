...
\newcommand\proofheader{{\sffamily\textbf{Proof:}}}
\newcommand\mcase[1]{{\sffamily\textbf{Case: #1}}}
...
\declaretheoremstyle[
  headfont=\sffamily,
  headformat=\textbf{\NAME},
  headpunct=:,
  qed=\qedsymbol,
]{plainproofbox}
\declaretheorem[style=plainproofbox, name=Proof]{plainproof}
