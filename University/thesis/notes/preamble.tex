...
\usepackage{braket} % Required for bra-ket notation
...
\newcommand\htp[1]{\mathop{\simeq}\limits_{#1}}
...
\newcommand\codv[2][]{\odv[style-inf-num=\mathrm{D}]{#1}{#2}}

% Metric
\newcommand\metric{\mathrm{d}}

% Differentials
\newcommand\dd[2][]{\odif[#1]{#2}}
\newcommand\pd[2][]{\pdif[#1]{#2}}
\newcommand\Dd[2][]{\mdif[#1]{#2}}
...
\newcommand\wwith{\quad\textrm{with}\quad}
...
\newtheorem{examplepln}{Example}[subsection]
\newenvironment{example}
  {\pushQED{\qed}\renewcommand{\qedsymbol}{\mbox{$\backslash\backslash$}}\begin{examplepln}}
  {\popQED\end{examplepln}}

\newtheorem{examplespln}{Examples}[examplepln]
\newenvironment{examples}
  {\pushQED{\qed}\renewcommand{\qedsymbol}{\mbox{$\backslash\backslash$}}\begin{examplespln}}
  {\popQED\end{examplespln}}
...
\newtheorem{computational-work}{Computational Work}[subsection]
...
\newenvironment{solution}[1][]{%
  \begin{proof}[Solution\ifthenelse{\equal{#1}{}}{}{~(#1)}]
}{%
  \end{proof}
}
...
\newcommand{\cref@nameSuffix}{%
  \ifx\cref@currentname\@empty\else{ }(\cref@currentname)\fi
}

\crefformat{theorem}{#2Theorem~#1\cref@nameSuffix#3}
\Crefformat{theorem}{#2Theorem~#1#3}

\crefformat{proposition}{#2Proposition~#1\cref@nameSuffix#3}
\Crefformat{proposition}{#2Proposition~#1#3}

\crefformat{definition}{#2Definition~#1\cref@nameSuffix#3}
\Crefformat{definition}{#2Definition~#1#3}

\crefformat{computational-work}{#2Computational Work~#1#3}
\Crefformat{computational-work}{#2Computational Work~#1#3}
